...
class Program
{
    static void Main()
    {
        Goalkeeper goalkeeper1 = new Goalkeeper("Iliq Ivanov", 38, 4, 185);
        Defender defender1 = new Defender("Georgi Oliver", 27, 5, 180);
        Midfielder midfielder1 = new Midfielder("Mitko Kostov", 23, 8, 175);
        Striker striker1 = new Striker("Alex Alex", 29, 10, 180);

        Coach coach1 = new Coach("Oliver Ostin", 45);

        FootballPlayer[] team1Players = { goalkeeper1, defender1, midfielder1, striker1 };
        Team team1 = new Team(coach1, team1Players);

        Defender defender2 = new Defender("Metodi Ivanov", 26, 4, 182);
        Midfielder midfielder2 = new Midfielder("Kristo Stiven", 24, 7, 177);
        Striker striker2 = new Striker("Goran Ognqnov", 28, 9, 183);
        FootballPlayer[] team2Players = { goalkeeper1, defender2, midfielder2, striker2 };
        Team team2 = new Team(coach1, team2Players);

        Referee referee1 = new Referee("Hristo Pavlov", 40);

        Game game1 = new Game(team1, team2, referee1);

        game1.AddGoal("35'", "Alex Alex");
        game1.AddGoal("65'", "Alex Alex");
